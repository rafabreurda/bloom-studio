  ...
  const fetchClients = useCallback(async () => {
    try {
      ...
      setClients(data?.map(c => ({
        ...
        clientSince: c.client_since || undefined,
  ...
  const addClient = async (client: Omit<Client, 'id' | 'createdAt' | 'history'>) => {
    try {
      ...
      const newClient: Client = {
        ...
        addressStreet: (data as any).address_street || undefined,
        addressNumber: (data as any).address_number || undefined,
        addressType: (data as any).address_type || undefined,
        addressNeighborhood: (data as any).address_neighborhood || undefined,
        addressCity: (data as any).address_city || undefined,
        addressState: (data as any).address_state || undefined,
        addressZip: (data as any).address_zip || undefined,
        birthday: data.birthday || undefined,
        cpf: data.cpf || undefined,
        neighborhood: data.neighborhood || undefined,
        city: data.city || undefined,
        clientSince: data.client_since || undefined,
